...
// Singleton — reuse existing client if already created
const existing = globalThis.__supabaseClient;
export const supabase = existing ?? createClient(supabaseUrl, supabaseKey, {
  auth: { storageKey: "utwx-auth" }
});
